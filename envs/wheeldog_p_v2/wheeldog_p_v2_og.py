...
from envs.wheeldog_p_v2.utils.noise_generator_utils import truncated_gaussian_noisy_data, uniform_noisy_data
...
class WheelDogPV2(MujocoEnv, utils.EzPickle):
    ...
    def __init__(self, config, render_flag=True, render_mode='human'):
        ...
        self.action_scaler = np.array(leg_scaler + wheel_scaler, dtype=np.float64)     

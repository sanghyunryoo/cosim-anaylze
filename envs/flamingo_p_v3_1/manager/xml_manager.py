...
class XMLManager:
    ...
    def get_model_path(self):
        if self.has_wheels:
            if self.use_gear:
                original_model_path = os.path.join(self.cur_dir, '..', 'assets', 'xml', 'flamingo_p_v3.xml')
            else:
                original_model_path = os.path.join(self.cur_dir, '..', 'assets', 'xml', 'flamingo_p_v3_no_gear.xml')
        else:
            original_model_path = os.path.join(self.cur_dir, '..', 'assets', 'xml', 'flamingo_p_v3_point_foot.xml')
        ...
        randomized_model_path = os.path.join(self.cur_dir, '..', 'assets', 'xml', 'applied_flamingo_p_v3_1.xml')
